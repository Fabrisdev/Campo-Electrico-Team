 ...
 * @author Fabri
 */
public class Frm2PlacaOpcion1LargoAncho extends javax.swing.JFrame {
    ...
    public Frm2PlacaOpcion1LargoAncho() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtAnchoQ1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtAnchoQ1ActionPerformed(evt);
            }
        });
        ...
        getContentPane().add(positivoQ2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 190, 160, 180));

        negativoQ2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/PlacaNegativo.png"))); // NOI18N
        getContentPane().add(negativoQ2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 190, 160, 180));

        negativoQ1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/PlacaNegativo.png"))); // NOI18N
        getContentPane().add(negativoQ1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 190, 160, 180));

        positivoQ1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/PlacaPositivo.png"))); // NOI18N
        getContentPane().add(positivoQ1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 190, 160, 180));
        ...
        lblFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/2PlacasSeleccion0LargoAncho.png"))); // NOI18N
    ...
    void actualizarCampo(){
        ...
        if(esNumero(txtCargaQ1.getText()) && esNumero(txtExponenteQ1.getText()) && esNumero(txtLargoQ1.getText()) && esNumero(txtAnchoQ1.getText())){
            ...
            if(esNumero(txtCargaQ2.getText()) && esNumero(txtExponenteQ2.getText()) && esNumero(txtLargoQ2.getText()) && esNumero(txtAnchoQ2.getText())){
    ...
    private void txtAnchoQ1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtAnchoQ1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtAnchoQ1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm2PlacaOpcion1LargoAncho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
