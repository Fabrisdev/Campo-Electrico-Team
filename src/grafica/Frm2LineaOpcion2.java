 ...
 * @author Fabri
 */
public class Frm2LineaOpcion2 extends javax.swing.JFrame {
    ...
    public Frm2LineaOpcion2() {
        initComponents();
        flechaArriba.setVisible(false);
        flechaAbajo.setVisible(false);
        setTitle("PR: Dos líneas | Equipo Dinamita");
    ...
    private void initComponents() {
        ...
        negativoQ2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/Linea_Negativa.png"))); // NOI18N
        getContentPane().add(negativoQ2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 355, 490, 50));

        positivoQ2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/Linea_Positiva.png"))); // NOI18N
        getContentPane().add(positivoQ2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 355, 490, 50));

        negativoQ1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/Linea_Negativa.png"))); // NOI18N
        getContentPane().add(negativoQ1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, 490, 50));

        positivoQ1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/Linea_Positiva.png"))); // NOI18N
        getContentPane().add(positivoQ1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, 490, 50));
        ...
        txtLargoQ2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtLargoQ2ActionPerformed(evt);
            }
        });
        ...
        getContentPane().add(txtLargoQ2, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 200, 150, 40));
        ...
        getContentPane().add(txtLargoQ1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 150, 150, 40));
        ...
        getContentPane().add(txtDistanciaQ2, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 300, 150, 40));
        ...
        getContentPane().add(txtDistanciaQ1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 250, 150, 40));
        ...
        getContentPane().add(flechaArriba, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 340, -1, -1));

        flechaAbajo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/FlechaAbajo.png"))); // NOI18N
        getContentPane().add(flechaAbajo, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 460, -1, 100));

        lblFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/2LineasSeleccion2.png"))); // NOI18N
    ...
    void actualizarCampo(){
        double e0 = 8.8e-12;
        double pi = 3.14;
        if(esNumero(txtCargaQ1.getText()) && esNumero(txtExponenteQ1.getText()) && esNumero(txtDistanciaQ1.getText()) && esNumero(txtLargoQ1.getText()) && esNumero(txtDistanciaQ2.getText())){
            ...
            double distanciaIncompletaQ1 = Double.parseDouble(txtDistanciaQ1.getText());
            double distanciaQ1 = distanciaIncompletaQ1 + distanciaQ2;
            double largoQ1 = Double.parseDouble(txtLargoQ1.getText());
            double lambdaQ1 = cargaCompletaQ1 / largoQ1;
            double campoQ1 = lambdaQ1 / (2 * pi * e0 * distanciaQ1);
            if(esNumero(txtCargaQ2.getText()) && esNumero(txtExponenteQ2.getText()) && esNumero(txtDistanciaQ2.getText()) && esNumero(txtLargoQ2.getText())){
                ...
                double lambdaQ2 = cargaCompletaQ2 / largoQ2;
                double campoQ2 = lambdaQ2 / (2 * pi * e0 * distanciaQ2);
    ...
    private void txtLargoQ2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtLargoQ2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtLargoQ2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm2LineaOpcion2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
