 ...
 * @author Fabri
 */
public class Frm2CargaOpcion0 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblCampo, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 370, 200, 50));
        ...
        lblFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/2CargasSeleccion0.png"))); // NOI18N
        ...
        if(esNumero(txtCargaQ1.getText()) && esNumero(txtExponenteQ1.getText()) && esNumero(txtDistanciaQ1.getText())){
            ...
            if(esNumero(txtCargaQ1.getText()) && !esNumero(txtCargaQ2.getText())){
                ...
                if(cargaQ1 > 0 && txtCargaQ2.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2CargasSeleccion1Pos0.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 < 0 && txtCargaQ2.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2CargasSeleccion1Neg0.png"));
                    lblFondo.setIcon(icon);
                }      
            }
            if(esNumero(txtCargaQ2.getText()) && !esNumero(txtCargaQ1.getText())){
                ...
                if(cargaQ2 > 0 && txtCargaQ1.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2CargasSeleccion2Pos0.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ2 < 0 && txtCargaQ1.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2CargasSeleccion2Neg0.png"));
                    lblFondo.setIcon(icon);
                }
            }
            if(esNumero(txtCargaQ1.getText()) && esNumero(txtCargaQ2.getText())){
                ...
                if(cargaQ1 > 0 && cargaQ2 > 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2CargasSeleccionAmbasPos0.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 < 0 && cargaQ2 < 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2CargasSeleccionAmbasNeg0.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 > 0 && cargaQ2 < 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2CargasSeleccion1Pos2Neg0.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 < 0 && cargaQ2 > 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2CargasSeleccion1Neg2Pos0.png"));
                    lblFondo.setIcon(icon);
                }
            }
    }
    ...
    void revisarTexto(JTextField jText){
        ...
        ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2CargasSeleccion0.png"));
        lblFondo.setIcon(icon);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm2CargaOpcion0.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
