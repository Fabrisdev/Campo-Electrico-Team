...
public class FrmLeerEcucacionesCampoElectrico extends javax.swing.JFrame {

    private int posicionSeleccionada;
    private boolean menuAbierto;
    private boolean menuMoviendose;
    
    public FrmLeerEcucacionesCampoElectrico() {
        initComponents();
        posicionSeleccionada = 1;
        setTitle("PR: Ecuaciones campo eléctrico | Equipo Dinamita");
    ...
    private void initComponents() {
        ...
        lblFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/Ecuaciones1.png"))); // NOI18N
    ...
    private void lblBtnSiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBtnSiguienteMouseClicked
        if(posicionSeleccionada >= 1 && posicionSeleccionada < 3)
            posicionSeleccionada += 1;
        ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/Ecuaciones"+posicionSeleccionada+".png"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmLeerEcucacionesCampoElectrico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
