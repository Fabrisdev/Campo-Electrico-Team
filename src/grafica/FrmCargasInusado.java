 ...
 * @author Paña
 */
public class FrmCargasInusado extends javax.swing.JFrame {
        ...
        this.jPanel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(e.getButton() == CLICK_IZQUIERDO){
                    try {
                        if(!cbCargaPrueba.isSelected()){
                            double valorCarga = Double.parseDouble(FrmCargasInusado.this.txtCarga.getText());
                            valorCarga *= Math.pow(10.0D, Integer.parseInt(FrmCargasInusado.this.txtCargaExp.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCargasInusado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmCargasInusado().setVisible(true);
            }
        });
    }
