...
public class Frm2LineaOpciones extends javax.swing.JFrame {

    private int posicionSeleccionada;
     private boolean menuAbierto;
    private boolean menuMoviendose;
    
    public Frm2LineaOpciones() {
        initComponents();
        setTitle("PR: Dos líneas opciones | Equipo Dinamita");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm2LineaOpciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
