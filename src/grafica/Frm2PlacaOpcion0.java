 ...
 * @author Fabri
 */
public class Frm2PlacaOpcion0 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/2PlacasSeleccion0.png"))); // NOI18N
        ...
        if(esNumero(txtCargaQ1.getText()) && esNumero(txtExponenteQ1.getText()) && esNumero(txtAreaQ1.getText())){
            ...
            if(esNumero(txtCargaQ1.getText()) && !esNumero(txtCargaQ2.getText())){
                ...
                if(cargaQ1 > 0 && txtCargaQ2.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion1Pos0.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 < 0 && txtCargaQ2.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion1Neg0.png"));
                    lblFondo.setIcon(icon);
                }      
            }
            if(esNumero(txtCargaQ2.getText()) && !esNumero(txtCargaQ1.getText())){
                ...
                if(cargaQ2 > 0 && txtCargaQ1.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion2Pos0.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ2 < 0 && txtCargaQ1.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion2Neg0.png"));
                    lblFondo.setIcon(icon);
                }
            }
            if(esNumero(txtCargaQ1.getText()) && esNumero(txtCargaQ2.getText())){
                ...
                if(cargaQ1 > 0 && cargaQ2 > 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccionAmbasPos0.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 < 0 && cargaQ2 < 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccionAmbasNeg0.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 > 0 && cargaQ2 < 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion1Pos2Neg0.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 < 0 && cargaQ2 > 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion1Neg2Pos0.png"));
                    lblFondo.setIcon(icon);
                }
            }
    }
    ...
    void revisarTexto(JTextField jText){
        ...
        ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion0.png"));
        lblFondo.setIcon(icon);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm2PlacaOpcion0.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
