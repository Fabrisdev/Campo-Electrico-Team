 ...
 * @author Fabri
 */
public class Frm1Placa extends javax.swing.JFrame {
    ...
    public Frm1Placa() {
        initComponents();
        setTitle("PR: Una placa | Equipo Dinamita");
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtArea, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 90, 100, 40));
    ...
    void actualizarCampo(){
        if(esNumero(txtCargaQ1.getText())){
            ...
            if(esNumero(txtExponente.getText())){
                ...
                if(esNumero(txtArea.getText())){
                    double distancia = Double.parseDouble(txtArea.getText());
                    if(distancia > 0){
                        txtArea.setBackground(new Color(0,0,0,0));
                        double sigma = cargaCompleta / distancia;
                        double k = 9e9;
                        double e0 = 8.8e-12;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm1Placa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
