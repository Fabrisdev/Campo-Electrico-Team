 ...
 * @author Fabri
 */
public class Frm3CargaOpcion3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(positivaQ1, new org.netbeans.lib.awtextra.AbsoluteConstraints(67, 235, -1, -1));

        negativaQ1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/Negativa.png"))); // NOI18N
        getContentPane().add(negativaQ1, new org.netbeans.lib.awtextra.AbsoluteConstraints(67, 235, -1, -1));

        positivaQ2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/Positiva.png"))); // NOI18N
        getContentPane().add(positivaQ2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 230, -1, -1));

        negativaQ2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/Negativa.png"))); // NOI18N
        getContentPane().add(negativaQ2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 230, -1, -1));

        positivaQ3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/Positiva.png"))); // NOI18N
        getContentPane().add(positivaQ3, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 235, -1, -1));

        negativaQ3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/Negativa.png"))); // NOI18N
        getContentPane().add(negativaQ3, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 240, -1, -1));

        flechaIzq.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/FlechaIzq.png"))); // NOI18N
        getContentPane().add(flechaIzq, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 210, -1, -1));
        ...
        lblFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/3CargasSeleccion3.png"))); // NOI18N
    ...
    void actualizarCampo(){
        double k = 9e9;
        if(esNumero(txtCargaQ1.getText()) && esNumero(txtExponenteQ1.getText()) && esNumero(txtDistanciaQ1.getText()) && esNumero(txtDistanciaQ2.getText()) && esNumero(txtDistanciaQ3.getText())){
            ...
            double distanciaQ3 = Double.parseDouble(txtDistanciaQ3.getText());
            double distanciaQ2 = distanciaIncompletaQ2 + distanciaQ3;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm3CargaOpcion3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
