 ...
 * @author Fabri
 */
public class Frm3CargaOpcion2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(flechaIzq, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 210, -1, -1));

        flechaDer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/FlechaDer.png"))); // NOI18N
        getContentPane().add(flechaDer, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 210, -1, -1));

        lblFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/3CargasSeleccion2.png"))); // NOI18N
    ...
    void actualizarCampo(){
        double k = 9e9;
        if(esNumero(txtCargaQ1.getText()) && esNumero(txtExponenteQ1.getText()) && esNumero(txtDistanciaQ1.getText()) && esNumero(txtDistanciaQ2.getText())){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm3CargaOpcion2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
