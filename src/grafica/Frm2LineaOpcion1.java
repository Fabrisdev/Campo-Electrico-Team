 ...
 * @author Fabri
 */
public class Frm2LineaOpcion1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(flechaAbajo, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 110, -1, -1));

        lblFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/2LineasSeleccion1.png"))); // NOI18N
        ...
        if(esNumero(txtCargaQ1.getText()) && esNumero(txtExponenteQ1.getText()) && esNumero(txtDistanciaQ1.getText()) && esNumero(txtLargoQ1.getText())){
            ...
            if(esNumero(txtCargaQ1.getText()) && !esNumero(txtCargaQ2.getText())){
                ...
                if(cargaQ1 > 0 && txtCargaQ2.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2Lineas1Pos1.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 < 0 && txtCargaQ2.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2Lineas1Neg1.png"));
                    lblFondo.setIcon(icon);
                }      
            }
            if(esNumero(txtCargaQ2.getText()) && !esNumero(txtCargaQ1.getText())){
                ...
                if(cargaQ2 > 0 && txtCargaQ1.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2Lineas2Pos1.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ2 < 0 && txtCargaQ1.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2Lineas2Neg1.png"));
                    lblFondo.setIcon(icon);
                }
            }
            if(esNumero(txtCargaQ1.getText()) && esNumero(txtCargaQ2.getText())){
                ...
                if(cargaQ1 > 0 && cargaQ2 > 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2LineasAmbasPos1.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 < 0 && cargaQ2 < 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2LineasAmbasNeg1.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 > 0 && cargaQ2 < 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2Lineas1Pos2Neg1.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 < 0 && cargaQ2 > 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2Lineas1Neg2Pos1.png"));
                    lblFondo.setIcon(icon);
                }
            }
    }
    ...
    void revisarTexto(JTextField jText){
        ...
        ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2LineasSeleccion1.png"));
        lblFondo.setIcon(icon);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm2LineaOpcion1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
