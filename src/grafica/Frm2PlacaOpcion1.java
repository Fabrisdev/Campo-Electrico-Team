 ...
 * @author Fabri
 */
public class Frm2PlacaOpcion1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(flechaIzq, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, -1, -1));

        flechaDer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/FlechaDer.png"))); // NOI18N
        getContentPane().add(flechaDer, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 210, -1, -1));

        lblFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/grafica/img/2PlacasSeleccion1.png"))); // NOI18N
        ...
        if(esNumero(txtCargaQ1.getText()) && esNumero(txtExponenteQ1.getText()) && esNumero(txtAreaQ1.getText())){
            ...
            if(esNumero(txtCargaQ1.getText()) && !esNumero(txtCargaQ2.getText())){
                ...
                if(cargaQ1 > 0 && txtCargaQ2.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion1Pos1.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 < 0 && txtCargaQ2.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion1Neg1.png"));
                    lblFondo.setIcon(icon);
                }      
            }
            if(esNumero(txtCargaQ2.getText()) && !esNumero(txtCargaQ1.getText())){
                ...
                if(cargaQ2 > 0 && txtCargaQ1.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion2Pos1.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ2 < 0 && txtCargaQ1.getText().equals("")){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion2Neg1.png"));
                    lblFondo.setIcon(icon);
                }
            }
            if(esNumero(txtCargaQ1.getText()) && esNumero(txtCargaQ2.getText())){
                ...
                if(cargaQ1 > 0 && cargaQ2 > 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccionAmbasPos1.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 < 0 && cargaQ2 < 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccionAmbasNeg1.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 > 0 && cargaQ2 < 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion1Pos2Neg1.png"));
                    lblFondo.setIcon(icon);
                }
                if(cargaQ1 < 0 && cargaQ2 > 0){
                    ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion1Neg2Pos1.png"));
                    lblFondo.setIcon(icon);
                }
            }
    }
    ...
    void revisarTexto(JTextField jText){
        ...
        ImageIcon icon = new ImageIcon(FrmMenu.class.getResource("/grafica/img/2PlacasSeleccion1.png"));
        lblFondo.setIcon(icon);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm2PlacaOpcion1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
